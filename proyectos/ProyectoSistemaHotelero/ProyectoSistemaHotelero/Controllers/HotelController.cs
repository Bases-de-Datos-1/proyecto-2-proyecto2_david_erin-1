    ...
    public class HotelController : Controller
    {
        ...
        private async Task<List<HabitacionListViewModel>> ObtenerHabitacionesPorHotel(string cedulaJuridica)
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"StackTrace: {ex.StackTrace}");
                throw; // Re-lanzamos la excepción para mantener el mensaje original
            }
        }
        ...
        SELECT 
            ...
            th.Nombre,
            th.Descripcion,
            th.Precio as PrecioPorNoche, -- Cambio aquí para usar alias correcto
            th.CapacidadMaxima,
        ...
        private async Task<(bool Success, string Message)> EliminarHabitacionPorId(int habitacionId, string cedulaJuridica)
        {
            ...
            return (true, "Habitación eliminada exitosamente.");
        }
